        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row w-full md:gap-32 gap-10 ">
            <div className="text-center lg:text-left">
              <h1 className="text-6xl font-bold text-[#1C68FA] mb-5">
                facebook
              </h1>
            ...
            <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
              <form onSubmit={handleLogin} className="card-body">
                ...
                <div className="form-control mt-6">
                  <input
                    className="bg-[#1c68FA] py-3 rounded-md font-bold text-2xl text-white"
                    type="submit"
                    value="Log in"
                  />
                ...
                <div className="text-center">
                  <button className="bg-[#3FA430] w-2/3 py-3 rounded-md font-bold text-xl text-white">
                    Create new account
                  </button>
                </div>
              </form>
